...
PlaySound = {
              "https://github.com/JohnyGamingLUA/A-666/blob/main/funnyscribbleman.mp3?raw=true", -- SoundId Link or Roblox ID
    ...
    CustomDialog = {  
        ...
        {"Come on, is it really that hard?", "I feel like I don't have to explain what to do for this one...", "I'll see you next time"},
         {"The scribble face again? In this place?", "Just find a hiding place", "Really not that hard", " Anyways, I'll see you next time at my place"}
    }
})
